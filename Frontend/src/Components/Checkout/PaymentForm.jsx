...
const PaymentForm = ({ address, total }) => {
  ...
  const startPayment = async () => {
    ...
    try {
      ...
      const createRes = await fetch("https://e-commerce-snapcart.onrender.com/payment/create-order", {
        method: "POST",
        headers: {
      ...
      const options = {
        ...
        handler: async (resp) => {
          try {
            ...
            const verifyRes = await fetch("https://e-commerce-snapcart.onrender.com/payment/verify-and-save", {
              method: "POST",
              headers: {
                "Content-Type": "application/json",
                "auth-token": localStorage.getItem("token") || "",
